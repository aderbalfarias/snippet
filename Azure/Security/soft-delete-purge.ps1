...
Undo-AzureRmKeyVaultRemoval -VaultName "AddressBookPlusVault03" -ResourceGroupName "Pluralsight" -Location "northeurope"
...
Remove-AzureRmKeyVault -VaultName AddressBookPlusVault03 -InRemovedState -Location 'northeurope'