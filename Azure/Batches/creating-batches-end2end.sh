...
az group create --name az203-batches --location northeurope

az storage account create --name az203batchesstorage --resource-group az203-batches

az batch account create --name az203batchtest  --storage-account az203batchesstorage --resource-group az203-batches --location northeurope
az203batchtest.northeurope.batch.azure.com
