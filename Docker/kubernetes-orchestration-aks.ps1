...
# 1. deploy the app
kubectl apply -f kubernetes-orchestration-sample-app.yaml
...
kubectl apply -f .\kubernetes-orchestration-example-vote.yml
...
kubectl apply -f .\kubernetes-orchestration-example-vote-v2.yml
...
kubectl delete -f .\kubernetes-orchestration-example-vote-v2.yml
