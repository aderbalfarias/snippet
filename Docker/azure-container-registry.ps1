...
# see the images we have - should have itworks:v2
docker image ls

# give it a new tag
docker tag itworks:v2 $loginServer/itworks:v2
...
# view the tags for the itworks repository
az acr repository show-tags -n $registryName --repository itworks -o table

# delete a repository from the 
az acr repository delete -n $registryName -t itworks:v2

# to delete everything was done above
